...
#define DEF_MSG_NOTIFY_LOTERY_LOST			"You draw a blank. Please try again next time.."
...
#define DEF_MSG_NOTIFY_ANGEL_FAILED			"Impossible to get a Tutelary Angel." // Invented by Snoopy...
...
#define	NOTIFY_MSG_HANDLER38	"Una nueva pelota ha sido creada!"
...
#define	UPDATE_SCREEN_ON_LOG_MSG16	"Try to login again. Thanks"
...
#define	 NPC_NAME_CENTAUR		"Centaurus"
...
#define NPC_NAME_GAIL			"Trade Officer"
#define NPC_NAME_GATE			"Gate"
#define NPC_NAME_ASSASAIN		"Assassin Officer"

// CLEROTH - NEW MONSTERS
#define NPC_NAME_AIRLEMENTAL			"Air Elemental"

#define NPC_NAME_ICELWORM				"Ice Worm"
#define NPC_NAME_FIRELWORM				"Fire Worm"
#define NPC_NAME_BLUELDEMON				"Blue Demon"
#define NPC_NAME_REDLDEMON				"Red Demon"
#define NPC_NAME_WOODLGOLEM				"Wood Golem"
#define NPC_NAME_ICELLIZARD				"Ice Lizard"
#define NPC_NAME_BUTCHERL				"Butcher"	
#define NPC_NAME_SNOOBL					"Snoob"
#define NPC_NAME_FIRELSNOOB				"Fire Snoob"
#define NPC_NAME_SATANL					"Satan"
#define NPC_NAME_GIANTLSPIDER			"Giant Spider"
#define NPC_NAME_DIABLOL				"Diablo"
#define NPC_NAME_PHAMTONL				"Phantom"
#define NPC_NAME_YETIL    				"Yeti"
#define NPC_NAME_GRANDLETTIN			"Grand Ettin"
#define NPC_NAME_HELLDEATH				"Hell Death"
#define NPC_NAME_LIGHTWORM				"Light Worm"
#define NPC_NAME_GRANDGOLEM				"Grand Golem"
#define NPC_NAME_GHOSTABA				"Ghost Abaddon"
#define NPC_NAME_GOBLIN					"Red Goblin"
#define NPC_NAME_GMGOBLIN				"Blue Goblin"
#define NPC_NAME_DANNY					"Danny"
#define NPC_NAME_GuardS					"Guard"
#define NPC_NAME_GuardA					"Guard"
#define NPC_NAME_GuardR					"Guard"
#define NPC_NAME_BLACKWYVERN			"Black Wyvern"
#define NPC_NAME_MARKETMOB				"Market Officer"
...
#define	DRAW_OBJECT_NAME91	"(Helbreath Cursed)"
#define	DRAW_OBJECT_NAME92	"?????"
...
#define	GET_OFFICIAL_MAP_NAME3	"Beginner Zone"//Lalo
...
#define	GET_OFFICIAL_MAP_NAME32	"Sailent Wood"
...
#define	GET_OFFICIAL_MAP_NAME47	"Aresden Church"
#define	GET_OFFICIAL_MAP_NAME48	"Elvine Church"
#define	GET_OFFICIAL_MAP_NAME49	"Ares-Middle DMZ"
#define	GET_OFFICIAL_MAP_NAME50	"Ares-Middle DMZ"
#define	GET_OFFICIAL_MAP_NAME51	"Elv-Middle DMZ"
#define	GET_OFFICIAL_MAP_NAME52	"Elv-Middle DMZ"
...
#define GET_OFFICIAL_MAP_NAME63	"Ares Jail"
#define GET_OFFICIAL_MAP_NAME64	"Elvin Jail"
#define GET_OFFICIAL_MAP_NAME65	"Promiseland"
#define GET_OFFICIAL_MAP_NAME66	"Ice Map"

//Lalo Mapas
#define GET_OFFICIAL_MAP_NAME70	"Druncian City"
#define GET_OFFICIAL_MAP_NAME71	"Infernia A"
#define GET_OFFICIAL_MAP_NAME72	"Infernia B"
#define GET_OFFICIAL_MAP_NAME73	"Maze"
#define GET_OFFICIAL_MAP_NAME74	"HighLand"//Procella
#define GET_OFFICIAL_MAP_NAME75	"Abaddon Map"
...
#define GET_OFFICIAL_MAP_NAME82	"Mortal Combat"//Lalo
#define GET_OFFICIAL_MAP_NAME84	"Hall"//"Assasain Hall"
#define GET_OFFICIAL_MAP_NAME85	"Cursed Barracks"
#define GET_OFFICIAL_MAP_NAME86	"Hell Of Death"
#define GET_OFFICIAL_MAP_NAME87	"Event Prizes"
#define GET_OFFICIAL_MAP_NAME88	"Summon Event"
#define GET_OFFICIAL_MAP_NAME89	"Summon Event"
#define	GET_OFFICIAL_MAP_NAME91	"All Vs All"
#define GET_OFFICIAL_MAP_NAME92	"Random Map"
#define GET_OFFICIAL_MAP_NAME93	"Hunt Map"
#define GET_OFFICIAL_MAP_NAME94 "Tower Defense"
#define GET_OFFICIAL_MAP_NAME95 "Cursed Events"
#define GET_OFFICIAL_MAP_NAME96 "Extreme Fight"
#define GET_OFFICIAL_MAP_NAME97 "VIP"
#define GET_OFFICIAL_MAP_NAME98	"Final Fight"
#define GET_OFFICIAL_MAP_NAME99	"PvP Event"
#define GET_OFFICIAL_MAP_NAME100 "Market Place"
#define GET_OFFICIAL_MAP_NAME101 "Tower Of Hell"
#define GET_OFFICIAL_MAP_NAME102 "Aresden Quest"
#define GET_OFFICIAL_MAP_NAME103 "Elvine Quest"
#define GET_OFFICIAL_MAP_NAME104 "World War Map"
#define GET_OFFICIAL_MAP_NAME105 "Ares Barracks"
#define GET_OFFICIAL_MAP_NAME106 "Elvin Barracks"
#define GET_OFFICIAL_MAP_NAME107 "War Extreme"
#define GET_OFFICIAL_MAP_NAME108 "All Eks"
#define GET_OFFICIAL_MAP_NAME109 "All Dk Eks"
...
#define	NPC_TALK_HANDLER36	"Item Reward: %s"


#define	NPC_NAME_MERCENARY	"Mercenary"
#define BGET_NPC_NAME23	", Party Member"

#define	GET_ITEM_NAME24B	"Poison Resistance"
#define	GET_ITEM_NAME25B	"Hitting Probability"
#define	GET_ITEM_NAME26B	"Defense Ratio"
#define	GET_ITEM_NAME27B	"HP recovery"
#define	GET_ITEM_NAME28B	"SP recovery"
#define	GET_ITEM_NAME29B	"MP recovery"
#define	GET_ITEM_NAME30B	"Magic Resistance"
#define	GET_ITEM_NAME31B	"Physical Absorption"
#define	GET_ITEM_NAME32B	"Magic Absorption"
#define	GET_ITEM_NAME33B	"Consecutive Attack Damage"
#define	GET_ITEM_NAME34B	"Experience"
#define	GET_ITEM_NAME35B	"Gold"
...
#define	UPDATE_SCREEN_ONGAME12	"Press Ctrol + P for Panel!"
...
#define	DRAW_DIALOGBOX_BANK3	"Either drag an item to restore from bag"
...
#define	DRAW_DIALOGBOX_CHARACTER10	"Rep (%d)"
...
#define	DRAW_DIALOGBOX_LEVELUP_SETTING14			"Please choose the setting point you want to"
#define	DRAW_DIALOGBOX_LEVELUP_SETTING15			"You can bring down 3 specific stats"
#define	DRAW_DIALOGBOX_LEVELUP_SETTING16			"points per ONE Majesty Point."
#define	DRAW_DIALOGBOX_LEVELUP_SETTING17			"Then, you can make an augment"
#define	DRAW_DIALOGBOX_LEVELUP_SETTING18			"the specific stats.                      "
#define	DRAW_DIALOGBOX_LEVELUP_SETTING19			"*Majesty:        Point"
#define	DRAW_DIALOGBOX_LEVELUP_SETTING20			"Your stats has been changed using Majestic Points."
...
#define	DRAW_DIALOGBOX_CITYHALL_MENU14	"Change the part of total war."
#define	DRAW_DIALOGBOX_CITYHALL_MENU17	"Select the function you want."
#define	DRAW_DIALOGBOX_CITYHALL_MENU17B	"Crusade mode"
...
#define	DRAW_DIALOGBOX_CITYHALL_MENU44	"Enemy kill count should be at"
#define	DRAW_DIALOGBOX_CITYHALL_MENU45	"least 300 to get a hero's cape."
#define	DRAW_DIALOGBOX_CITYHALL_MENU46	"Select the Item that you want."
#define	DRAW_DIALOGBOX_CITYHALL_MENU47	"Hero's Cape (EK 300)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU48	"Hero's Helm (EK 150  Contri 20)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU49	"Hero's Cap  (EK 100  Contri 20)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU50	"Hero's Armor (EK 300 Contri 30)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU51	"Hero's Robe (EK 200 Contri 20)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU52	"Hero's Hauberk (EK 100 Contri 10)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU53	"Hero's Leggings (EK 150 Contri 15)"
...
#define	DRAW_DIALOGBOX_GUILDMENU82	"Are you sure you want to leave your guild?."
#define DRAW_DIALOGBOX_GUILDMENU83	"Out of the guild"
...
#define	DRAW_DIALOGBOX_GUILD_OPERATION4	" he can withdraw from guild or not."
...
#define	DRAW_DIALOGBOX_GUILD_OPERATION27	"And you are a normal citizen."
...
#define	DRAW_DIALOGBOX_MAGICSHOP16	"Mana"


#define	DRAW_DIALOGBOX_NOTICEMSG1	" GameServer will be shut down after %d Minutes!"
#define	DRAW_DIALOGBOX_NOTICEMSG2	" GameServer will be shut down soon!"
#define	DRAW_DIALOGBOX_NOTICEMSG3	"You have to logout now to save your data"
#define	DRAW_DIALOGBOX_NOTICEMSG4	"safely. After beginning of shutdown, user's"
#define	DRAW_DIALOGBOX_NOTICEMSG5	"data are not saved and the lost data cannot"
#define	DRAW_DIALOGBOX_NOTICEMSG6	"be recovered. So be careful!!"
#define	DRAW_DIALOGBOX_NOTICEMSG7	" Shutdown has started.!!!!"
#define	DRAW_DIALOGBOX_NOTICEMSG8	"Your connection will be lost automatically"
#define	DRAW_DIALOGBOX_NOTICEMSG9	"soon. Don't drop items or give them other"
#define	DRAW_DIALOGBOX_NOTICEMSG10	"people. Data could be lost. And lost data"
#define	DRAW_DIALOGBOX_NOTICEMSG11	"cannot be recorvered."
...
#define	DRAW_DIALOGBOX_NPCACTION_QUERY43_ALL	"Repair All"
...
#define	DRAW_DIALOGBOX_PARTY6	"See the list of party members."
...
#define	DRAW_DIALOGBOX_PARTY31	"The character name"
#define	DRAW_DIALOGBOX_PARTY32	"of your party."
...
#define	DRAW_DIALOGBOX_QUERY_DROP_ITEM_AMOUNT7	"Decide the price."
...
#define	DRAW_DIALOGBOX_QUEST36	"Item Reward: %s"
...
#define	DRAW_DIALOGBOX_SYSMENU_SOUND         "Sound"
#define	DRAW_DIALOGBOX_SYSMENU_MUSICVOLUME   "M. Volume"
#define	DRAW_DIALOGBOX_SYSMENU_SOUNDVOLUME   "S. Volume"
#define	DRAW_DIALOGBOX_SYSMENU_TRANSPARENCY  "Transp. Box"
...
#define	DRAW_DIALOGBOX_SYSMENU_ON1            ">>"
#define	DRAW_DIALOGBOX_SYSMENU_OFF1           "<<"

#define	DRAW_DIALOGBOX_SYSMENU_ON2            "Big"
#define	DRAW_DIALOGBOX_SYSMENU_OFF2           "Small"
...
#define	NOTIFYMSG_ENEMYKILL_REWARD2	"You killed the enemy %s of %s guild!"
...
#define	NOTIFYMSG_ITEMPURCHASED1	"You bought a %s with %d Enemy Kills."
#define	NOTIFYMSG_ITEMPURCHASED2	"You bought a %s with %d Contributions."
#define	NOTIFYMSG_ITEMPURCHASED3	"You bought a %s with %d Coins."
#define	NOTIFYMSG_ITEMPURCHASED4	"You bought a %s with %d Pk Points."
...
#define	NOTIFYMSG_MAGICEFFECT_OFF16	"Fury of war mode released."
...
#define	NOTIFYMSG_MAGICEFFECT_ON16	"Fury Of War Magic Casted!"
...
#define	NOTIFYMSG_HP_UP	"HP+ %d"
#define	NOTIFYMSG_HP_DOWN	"HP- %d"
#define	NOTIFYMSG_MP_UP	"MP+ %d"
#define	NOTIFYMSG_MP_DOWN	"MP- %d"
#define	NOTIFYMSG_SP_UP	"SP+ %d"
#define	NOTIFYMSG_SP_DOWN	"SP- %d"
#define	NOTIFYMSG_HP2	"Logout count cancels if HP decreases during the countdown."
#define NOTIFYMSG_ChangeC2 "ChangeCity Count cancels if HP decreases during the countdown."
#define	NOTIFYMSG_HP3	"Warning! HP is very low. Danger!!"
#define NOTIFYMSG_DC2	"Logout count cancels if you are moving during the countdown."
#define NOTIFYMSG_ChangeC "ChangeCity Count cancels if you are moving during the countdown."
...
#define	NOTIFYMSG_PLAYER_SHUTUP1	"You got a penalty that you can't chat for %dseconds"
#define	NOTIFYMSG_PLAYER_SHUTUP2	"You gave %s a penalty that he can't chat for %dseconds."
...
#define	DRAW_DIALOGBOX_HELP1	"Helbreath Cursed?"
...
#define NOTIFY_MSG_DETAIL_LEVEL_USER	"Detail Level : User Config"
...
#define DEF_MSG_TOTAL_NUMBER "Total : %d"

#define DEF_MSG_EXP	"Exp: "

#define DEF_MSG_CHARACTERNAME	"Character Name"
#define DEF_MSG_GENDER			"Gender"
#define DEF_MSG_SKINCOLOR		"Skin Color"
#define DEF_MSG_HAIRSTYLE		"Hair Style"
#define DEF_MSG_HAIRCOLOR		"Hair Color"
#define DEF_MSG_UNDERWEARCOLOR	"Underwear Color"
#define DEF_MSG_STRENGTH		"Strength"
#define DEF_MSG_VITALITY		"Vitality"
#define DEF_MSG_DEXTERITY		"Dexterity"
#define DEF_MSG_INTELLIGENCE	"Intelligence"
#define DEF_MSG_MAGIC			"Magic"
...
#define DEF_MSG_MAPNAME_Isla		"LA ISLA"
//Snoopy
...
#define DEF_MSG_WARNING4	"To play the game in safe, go to the"
#define DEF_MSG_WARNING5	" cityhall and change to civilian mode."

#define	DEF_MSG_SAFEZONE	"This is a safe area."
#define	DEF_MSG_DANGERZONE	"You cannot be protected from others' attack in this area."

#define DEF_MSG_ARECIVIL	"Aresden Civilian"
#define DEF_MSG_ARESOLDIER	"Aresden Combatant"
#define DEF_MSG_ELVCIVIL	"Elvine Civilian"
#define DEF_MSG_ELVSOLDIER	"Elvine Combatant"
#define DEF_MSG_PK			"Assassin"//"Assasain"
#define DEF_MSG_AREPK		"Aresden Criminal"
#define DEF_MSG_ELVPK		"Elvine Criminal"
#define DEF_MSG_GUILDMASTER		"%s Guildmaster"
#define DEF_MSG_GUILDMASTER1	" Guildmaster"
#define DEF_MSG_GUILDSMAN		"%s Guildsman"
#define DEF_MSG_GUILDSMAN1		" Guildsman"
#define DEF_MSG_GM	"Helbreath Cursed"
#define DEF_MSG_ENEMY "Enemy"
...
#define DEF_MSG_GAMEMODE_CHANGED		"Play mode has been changed."

#define DRAW_DIALOGBOX_CITYHALL_MENU69	"Teleport List"
#define DRAW_DIALOGBOX_CITYHALL_MENU70	"5000Gold is required"
#define DRAW_DIALOGBOX_CITYHALL_MENU71	"to teleport."
...
#define DRAW_DIALOGBOX_CITYHALL_MENU77  "%s - Cost : %d"

#define	DRAW_DIALOGBOX_CITYHALL_MENUU78	"Take the Dk's items."
#define	DRAW_DIALOGBOX_CITYHALL_MENUU79	"Dark Knight Sword"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU80	"Dark Knight Rapier"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU81	"Dark Mage Wand"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU82	"Dark Knight Helm"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU83	"Dark Mage Hat"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU84	"Dark Knight PlateMail"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU85	"Dark Mage ChainMail"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU86	"Dark Mage Robe"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU87	"Dark Knight Hauberk"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU88	"Dark Knight Leggings"
#define	DRAW_DIALOGBOX_CITYHALL_MENUU89	"Dark Knight Hammer"

#define DRAW_DIALOGBOX_CITYHALL_MENU99  "%s"
...
#define DEF_MSG_NOTIFY_NOMOREAGRICULTURE	"You cannot farm any more."
...
#define RECALL_IN_CRUSADE_10_SECS "Tp cannot be used until 10 seconds after taking damage."


//#define DRAW_DIALOGBOX_DESTINY1             "[ARESDEN]"
//#define DRAW_DIALOGBOX_DESTINY2             "[ELVINE]"

#define	NOTIFYMSG_ITEMTRADE	"You bought a %s with %d Points." // MORLA 2.4 - Cuando compra un item por eks y dgs
#define	DRAW_DIALOGBOX_SHOP2	"Points"


#define NOTIFY_MSG_RUSHNETINIT "Cursed Rush ha iniciado!"
#define NOTIFY_MSG_RUSHNETFINISH1 "Cursed Rush ha terminado! - Gano Elvine"
#define NOTIFY_MSG_RUSHNETFINISH2 "Cursed Rush ha terminado! - Gano Aresden"
#define NOTIFY_MSG_RUSHNETFINISH3 "Cursed Rush ha terminado!"
#define NOTIFY_MSG_RUSHNETNOSTRUCTURE1 "La defensa de Aresden ha caido!"
#define NOTIFY_MSG_RUSHNETNOSTRUCTURE2 "La defensa de Elvine ha caido!"

#define NOTIFY_MSG_TOWERDINIT "Tower Defense ha iniciado!"
#define NOTIFY_MSG_TOWERDFINISH1 "Tower Defense ha terminado! - Gano Elvine"
#define NOTIFY_MSG_TOWERDFINISH2 "Tower Defense ha terminado! - Gano Aresden"
#define NOTIFY_MSG_TOWERDFINISH3 "Tower Defense ha terminado!"
#define NOTIFY_MSG_TOWERDNOSTRUCTURE1 "La defensa de Aresden ha caido! - Elvine Puede plantar la Flag!"
#define NOTIFY_MSG_TOWERDNOSTRUCTURE2 "La defensa de Elvine ha caido! - Aresden Puede plantar la Flag!"

#define NOTIFY_MSG_OPENFURYDAY "Fury Day a Comenzado!"
#define NOTIFY_MSG_CLOSEFURYDAY "Fury Day a Terminado!"

#define DRAW_DIALOGBOX_CITYHALL_MENU90	"Teleport to Promiseland"
//#define DRAW_DIALOGBOX_CITYHALL_MENU91	"Teleport to Volcano"


#define	DRAW_DIALOGBOX_CITYHALL_MENU78		"Trade EK Item List."

#define	DRAW_DIALOGBOX_CITYHALL_MENU79		"Trade EK List"
#define	DRAW_DIALOGBOX_CITYHALL_MENU80		"Plese select an item category:"
#define	DRAW_DIALOGBOX_CITYHALL_MENU80B		"Plese select category"

#define	DRAW_DIALOGBOX_CITYHALL_MENU81		"* Armors & Weapons *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU82		"* Necks & Rings *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU83		"* Power Hero Set *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU84		"* Magics Manuals *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU85		"* Dark Hero Parts *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU86		"* Others *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU87		"* Commands *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU88		"* Angelics *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU89		"* Pandoras Box *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU91		"* Reset Rank *"
#define	DRAW_DIALOGBOX_CITYHALL_MENU92		"*Killed total count*"
#define	DRAW_DIALOGBOX_CITYHALL_MENU93		"*Killed total count x 1*"
#define	DRAW_DIALOGBOX_CITYHALL_MENU94		"*Killed total friend count x 1*"

#define DRAW_DIALOGBOX_TRADEEKITEM0	"Item"
#define DRAW_DIALOGBOX_TRADEEKITEM0a "Precio"

// armors an weapons
#define DRAW_DIALOGBOX_TRADEEKITEM1 "Kloness Wand(MS.30)"
#define DRAW_DIALOGBOX_TRADEEKITEM1a "%d Eks"
#define PRICE_TRADEEKITEM1b 25000
#define DRAW_DIALOGBOX_TRADEEKITEM2 "Resurrection Wand(MS.30)"
#define DRAW_DIALOGBOX_TRADEEKITEM2a "%d Eks"
#define PRICE_TRADEEKITEM2b 15000
#define DRAW_DIALOGBOX_TRADEEKITEM3 "Berserk Wand(MS.30)"
#define DRAW_DIALOGBOX_TRADEEKITEM3a "%d Eks"
#define PRICE_TRADEEKITEM3b 55000
#define DRAW_DIALOGBOX_TRADEEKITEM4 "Demon Slayer"
#define DRAW_DIALOGBOX_TRADEEKITEM4a "%d Eks"
#define PRICE_TRADEEKITEM4b 20000
#define DRAW_DIALOGBOX_TRADEEKITEM5 "Lighting Blade"
#define DRAW_DIALOGBOX_TRADEEKITEM5a "%d Eks"
#define PRICE_TRADEEKITEM5b 55000
#define DRAW_DIALOGBOX_TRADEEKITEM6 "The Devastator"
#define DRAW_DIALOGBOX_TRADEEKITEM6a "%d Eks"
#define PRICE_TRADEEKITEM6b 160000
#define DRAW_DIALOGBOX_TRADEEKITEM7 "Kloness Axe" 
#define DRAW_DIALOGBOX_TRADEEKITEM7a "%d Eks"
#define PRICE_TRADEEKITEM7b 15000
#define DRAW_DIALOGBOX_TRADEEKITEM8 "Kloness Esterk"
#define DRAW_DIALOGBOX_TRADEEKITEM8a "%d Eks"
#define PRICE_TRADEEKITEM8b 10000
#define DRAW_DIALOGBOX_TRADEEKITEM9 "Kloness Blade"
#define DRAW_DIALOGBOX_TRADEEKITEM9a "%d Eks"
#define PRICE_TRADEEKITEM9b 45000
#define DRAW_DIALOGBOX_TRADEEKITEM10 "Storm Bringer"
#define DRAW_DIALOGBOX_TRADEEKITEM10a "%d Eks"
#define PRICE_TRADEEKITEM10b 140000
#define DRAW_DIALOGBOX_TRADEEKITEM11 "Power Hero Sword"
#define DRAW_DIALOGBOX_TRADEEKITEM11a "%d Eks"
#define PRICE_TRADEEKITEM11b 200000
#define DRAW_DIALOGBOX_TRADEEKITEM12 "Power Hero Wand"
#define DRAW_DIALOGBOX_TRADEEKITEM12a "%d Eks"
#define PRICE_TRADEEKITEM12b 200000

#define DRAW_DIALOGBOX_TRADEEKITEM13 "MerienShield"
#define DRAW_DIALOGBOX_TRADEEKITEM13a "%d Eks"
#define PRICE_TRADEEKITEM13b 60000
#define DRAW_DIALOGBOX_TRADEEKITEM14 "Merien PlateMail(M)"
#define DRAW_DIALOGBOX_TRADEEKITEM14a "%d Eks"
#define PRICE_TRADEEKITEM14b 30000
#define DRAW_DIALOGBOX_TRADEEKITEM15 "Merien PlateMail(W)"
#define DRAW_DIALOGBOX_TRADEEKITEM15a "%d Eks"
#define PRICE_TRADEEKITEM15b 30000
#define DRAW_DIALOGBOX_TRADEEKITEM29 "Giant Battle Hammer"
#define DRAW_DIALOGBOX_TRADEEKITEM29a "%d Eks"
#define PRICE_TRADEEKITEM29b 60000
#define DRAW_DIALOGBOX_TRADEEKITEM42 "Black Axe"
#define DRAW_DIALOGBOX_TRADEEKITEM42a "%d Eks"
#define PRICE_TRADEEKITEM42b 60000
#define DRAW_DIALOGBOX_TRADEEKITEM43 "Black Hammer"
#define DRAW_DIALOGBOX_TRADEEKITEM43a "%d Eks"
#define PRICE_TRADEEKITEM43b 80000
#define DRAW_DIALOGBOX_TRADEEKITEM44 "Black Devastator"
#define DRAW_DIALOGBOX_TRADEEKITEM44a "%d Eks"
#define PRICE_TRADEEKITEM44b 170000
#define DRAW_DIALOGBOX_TRADEEKITEM45 "Strip Ice Hammer"
#define DRAW_DIALOGBOX_TRADEEKITEM45a "%d Eks"
#define PRICE_TRADEEKITEM45b 250000
#define DRAW_DIALOGBOX_TRADEEKITEM46 "Ares ElfBow"
#define DRAW_DIALOGBOX_TRADEEKITEM46a "%d Eks"
#define PRICE_TRADEEKITEM46b 70000
#define DRAW_DIALOGBOX_TRADEEKITEM47 "Elvin ElfBow"
#define DRAW_DIALOGBOX_TRADEEKITEM47a "%d Eks"
#define PRICE_TRADEEKITEM47b 70000
#define DRAW_DIALOGBOX_TRADEEKITEM48 "Aresden Storm Bringer"
#define DRAW_DIALOGBOX_TRADEEKITEM48a "%d Eks"
#define PRICE_TRADEEKITEM48b 150000
#define DRAW_DIALOGBOX_TRADEEKITEM49 "Elvine Storm Bringer"
#define DRAW_DIALOGBOX_TRADEEKITEM49a "%d Eks"
#define PRICE_TRADEEKITEM49b 150000

//necks and rings
#define DRAW_DIALOGBOX_TRADEEKITEM16 "Ring of Power Mage"
#define DRAW_DIALOGBOX_TRADEEKITEM16a "%d Eks"
#define PRICE_TRADEEKITEM16b 20000
#define DRAW_DIALOGBOX_TRADEEKITEM17 "Ring of Power War"
#define DRAW_DIALOGBOX_TRADEEKITEM17a "%d Eks"
#define PRICE_TRADEEKITEM17b 20000
#define DRAW_DIALOGBOX_TRADEEKITEM18 "Neck Power(MS.30)"
#define DRAW_DIALOGBOX_TRADEEKITEM18a "%d Eks"
#define PRICE_TRADEEKITEM18b 10000
#define DRAW_DIALOGBOX_TRADEEKITEM19 "Neck Power Merien"
#define DRAW_DIALOGBOX_TRADEEKITEM19a "%d Eks"
#define PRICE_TRADEEKITEM19b 10000
#define DRAW_DIALOGBOX_TRADEEKITEM20 "Neck Power Xelima"
#define DRAW_DIALOGBOX_TRADEEKITEM20a "%d Eks"
#define PRICE_TRADEEKITEM20b 10000
#define DRAW_DIALOGBOX_TRADEEKITEM21 "Knecklace Of Medusa"
#define DRAW_DIALOGBOX_TRADEEKITEM21a "%d Eks"
#define PRICE_TRADEEKITEM21b 10000
#define DRAW_DIALOGBOX_TRADEEKITEM22 "Knecklace Of Beholder"
#define DRAW_DIALOGBOX_TRADEEKITEM22a "%d Eks"
#define PRICE_TRADEEKITEM22b 40000

#define DRAW_DIALOGBOX_TRADEEKITEM40 "Inhibition Casting Manual"
#define DRAW_DIALOGBOX_TRADEEKITEM40a "%d Eks" 
#define PRICE_TRADEEKITEM40b 30000

//Lalito
#define	DOWNCHARPT	"Logging out...%d"
#define	CHANGECIT	"Change City in...%d"

//TopEkList
#define DRAW_DIALOGBOX_TOPEKLITS0 "Pos." 
#define DRAW_DIALOGBOX_TOPEKLITS1 "Nombre"
#define DRAW_DIALOGBOX_TOPEKLITS2 "Ciudad"
#define DRAW_DIALOGBOX_TOPEKLITS3 "Eks"

#define DRAW_DIALOGBOX_NETPANEL "CursedPanel"
#define DRAW_DIALOGBOX_ACTPOSIBLE "Puedes Activar"
#define DRAW_DIALOGBOX_ACTNOPOSIBLE "No Puedes Activar"

#define DRAW_DIALOGBOX_SYSMENU_SHOWBAR      "Show Bar"

//RankUp
#define	DRAW_DIALOGBOX_RankUP_1		"When Rank up, your specific stats"
#define	DRAW_DIALOGBOX_RankUP_2		"will be increased by setting."
#define DRAW_DIALOGBOX_RankUP_3		"Rank Point left:"

//Assasain Heros
#define DRAW_DIALOGBOX_ASSASAIN_MENU00		"Assassin Officer"
#define	DRAW_DIALOGBOX_ASSASAIN_MENU01		"Assassin Hero"
#define DRAW_DIALOGBOX_ASSASAIN_MENU02		"Assassin Hero War"
#define DRAW_DIALOGBOX_ASSASAIN_MENU03		"Assassin Hero Mage"
#define	DRAW_DIALOGBOX_ASSASAIN_MENU04		"Assassin Weapons"
#define DRAW_DIALOGBOX_ASSASAIN_MENU05		"Assassin Weapons"
#define DRAW_DIALOGBOX_ASSASAIN_MENU06		"Assassin Wands"
#define DRAW_DIALOGBOX_ASSASAIN_MENU07		"Assassin Reset"
#define DRAW_DIALOGBOX_ASSASAIN_MENU08		"Change Pks for Eks"
#define DRAW_DIALOGBOX_ASSASAIN_MENU09		"Assassin Trade Items"
#define DRAW_DIALOGBOX_ASSASAIN_MENU10		"Item"
#define DRAW_DIALOGBOX_ASSASAIN_MENU11		"Price"

#define DRAW_DIALOGBOX_ASSASAINITEM01 "Assassin Helm"
#define DRAW_DIALOGBOX_ASSASAINITEM01a "%d Pks"
#define PRICE_ASSASAINITEM01b 2000

#define DRAW_DIALOGBOX_ASSASAINITEM02 "Assassin Armor"
#define DRAW_DIALOGBOX_ASSASAINITEM02a "%d Pks"
#define PRICE_ASSASAINITEM02b 2000

#define DRAW_DIALOGBOX_ASSASAINITEM03 "Assassin Hauberk"
#define DRAW_DIALOGBOX_ASSASAINITEM03a "%d Pks"
#define PRICE_ASSASAINITEM03b 2000

#define DRAW_DIALOGBOX_ASSASAINITEM04 "Assassin Leggings"
#define DRAW_DIALOGBOX_ASSASAINITEM04a "%d Pks"
#define PRICE_ASSASAINITEM04b 2000

#define DRAW_DIALOGBOX_ASSASAINITEM05 "Assassin Cape"
#define DRAW_DIALOGBOX_ASSASAINITEM05a "%d Pks"
#define PRICE_ASSASAINITEM05b 2000

#define DRAW_DIALOGBOX_ASSASAINITEM06 "Assassin Cap"
#define DRAW_DIALOGBOX_ASSASAINITEM06a "%d Pks"
#define PRICE_ASSASAINITEM06b 2000

#define DRAW_DIALOGBOX_ASSASAINITEM07 "Assassin Robe"
#define DRAW_DIALOGBOX_ASSASAINITEM07a "%d Pks"
#define PRICE_ASSASAINITEM07b 2000

#define DRAW_DIALOGBOX_ASSASAINITEM08 "Assassin Esterk"
#define DRAW_DIALOGBOX_ASSASAINITEM08a "%d Pks"
#define PRICE_ASSASAINITEM08b 2000

#define DRAW_DIALOGBOX_ASSASAINITEM09 "Assassin Blade"
#define DRAW_DIALOGBOX_ASSASAINITEM09a "%d Pks"
#define PRICE_ASSASAINITEM09b 4000

#define DRAW_DIALOGBOX_ASSASAINITEM10 "Assassin Axe"
#define DRAW_DIALOGBOX_ASSASAINITEM10a "%d Pks"
#define PRICE_ASSASAINITEM10b 6000

#define DRAW_DIALOGBOX_ASSASAINITEM11 "Assassin Barbarian Hammer"
#define DRAW_DIALOGBOX_ASSASAINITEM11a "%d Pks"
#define PRICE_ASSASAINITEM11b 8000

#define DRAW_DIALOGBOX_ASSASAINITEM12 "Assassin Magic Wand(MS.20)"
#define DRAW_DIALOGBOX_ASSASAINITEM12a "%d Pks"
#define PRICE_ASSASAINITEM12b 6000

#define DRAW_DIALOGBOX_ASSASAINITEM13 "Assassin Magic Wand(MS.40)"
#define DRAW_DIALOGBOX_ASSASAINITEM13a "%d Pks"
#define PRICE_ASSASAINITEM13b 8000

#define DRAW_DIALOGBOX_ASSASAINITEM20 "Rep Potion -100"
#define DRAW_DIALOGBOX_ASSASAINITEM20a "%d Pks"
#define PRICE_ASSASAINITEM20b 100


#define DRAW_DIALOGBOX_ASSASAINCITY1 "ARESDEN"
#define DRAW_DIALOGBOX_ASSASAINCITY2 "ELVINE"
#define PRICE_ASSASAINRESET		5000

#define DRAW_DIALOGBOX_OTHERS01 "Tinta Magica (Azul)"
#define DRAW_DIALOGBOX_OTHERS01a "%d Eks" 
#define PRICE_OTHERS01b 10000
#define DRAW_DIALOGBOX_OTHERS02 "Tinta Magica (Roja)"
#define DRAW_DIALOGBOX_OTHERS02a "%d Eks" 
#define PRICE_OTHERS02b 10000
#define DRAW_DIALOGBOX_OTHERS03 "Reflex Hauberk (W)"
#define DRAW_DIALOGBOX_OTHERS03a "%d Eks" 
#define PRICE_OTHERS03b 120000
#define DRAW_DIALOGBOX_OTHERS04 "Reflex Hauberk (M)"
#define DRAW_DIALOGBOX_OTHERS04a "%d Eks" 
#define PRICE_OTHERS04b 120000
#define DRAW_DIALOGBOX_OTHERS05 "Reputation Potion(+100)"
#define DRAW_DIALOGBOX_OTHERS05a "%d Eks" 
#define PRICE_OTHERS05b 1000
#define DRAW_DIALOGBOX_OTHERS06 "Aresden Flag´s"
#define DRAW_DIALOGBOX_OTHERS06a "%d Eks" 
#define PRICE_OTHERS06b 100
#define DRAW_DIALOGBOX_OTHERS07 "Elvine Flag´s"
#define DRAW_DIALOGBOX_OTHERS07a "%d Eks" 
#define PRICE_OTHERS07b 100
#define DRAW_DIALOGBOX_OTHERS08 "cloth Gloss (Blue)"
#define DRAW_DIALOGBOX_OTHERS08a "%d Eks" 
#define PRICE_OTHERS08b 10000
#define DRAW_DIALOGBOX_OTHERS09 "cloth Gloss (Red)"
#define DRAW_DIALOGBOX_OTHERS09a "%d Eks" 
#define PRICE_OTHERS09b 10000
//Nuevos Manuales
#define DRAW_DIALOGBOX_MMANUAL01 "Storm Of Death Manual"
#define DRAW_DIALOGBOX_MMANUAL01a "%d Eks" 
#define PRICE_MMANUAL01b 200000
#define DRAW_DIALOGBOX_MMANUAL02 "Fury Of War Manual"
#define DRAW_DIALOGBOX_MMANUAL02a "%d Eks" 
#define PRICE_MMANUAL02b 100000
#define DRAW_DIALOGBOX_MMANUAL03 "Blue Fire Manual"
#define DRAW_DIALOGBOX_MMANUAL03a "%d Eks" 
#define PRICE_MMANUAL03b 80000
#define DRAW_DIALOGBOX_MMANUAL04 "Heal Spot Manual"
#define DRAW_DIALOGBOX_MMANUAL04a "%d Eks" 
#define PRICE_MMANUAL04b 50000
//Rings y Necks Agregados al Panel
#define DRAW_DIALOGBOX_RYN01 "Ring of The Abaddon"
#define DRAW_DIALOGBOX_RYN01a "%d Eks" 
#define PRICE_RYN01b 5000
#define DRAW_DIALOGBOX_RYN02 "Ring of Arc Mage"
#define DRAW_DIALOGBOX_RYN02a "%d Eks" 
#define PRICE_RYN02b 5000
#define DRAW_DIALOGBOX_RYN03 "Necklace Of Merien"
#define DRAW_DIALOGBOX_RYN03a "%d Eks" 
#define PRICE_RYN03b 7500
#define DRAW_DIALOGBOX_RYN04 "Necklace Of Xelima"
#define DRAW_DIALOGBOX_RYN04a "%d Eks" 
#define PRICE_RYN04b 7500
#define DRAW_DIALOGBOX_RYN05 "NeckPower LightPro"
#define DRAW_DIALOGBOX_RYN05a "%d Eks" 
#define PRICE_RYN05b 50000
#define DRAW_DIALOGBOX_RYN06 "NeckPower AirEle"
#define DRAW_DIALOGBOX_RYN06a "%d Eks" 
#define PRICE_RYN06b 100000
//Power Hero Set 
#define DRAW_DIALOGBOX_POWER00 "Power Hero Aresden"
#define DRAW_DIALOGBOX_POWERe00 "Power Hero Elvine"
//ARESDEN
#define DRAW_DIALOGBOX_POWER01 "PowerAresHeroHelmW"
#define DRAW_DIALOGBOX_POWER01a "%d Eks"
#define PRICE_POWER01b 5000
#define DRAW_DIALOGBOX_POWER02 "PowerAresHeroHelmM"
#define DRAW_DIALOGBOX_POWER02a "%d Eks"
#define PRICE_POWER02b 5000
#define DRAW_DIALOGBOX_POWER03 "PowerAresHeroArmorW"
#define DRAW_DIALOGBOX_POWER03a "%d Eks"
#define PRICE_POWER03b 5000
#define DRAW_DIALOGBOX_POWER04 "PowerAresHeroArmorM"
#define DRAW_DIALOGBOX_POWER04a "%d Eks"
#define PRICE_POWER04b 5000
#define DRAW_DIALOGBOX_POWER05 "PowerAresHeroHauberkW"
#define DRAW_DIALOGBOX_POWER05a "%d Eks"
#define PRICE_POWER05b 5000
#define DRAW_DIALOGBOX_POWER06 "PowerAresHeroHauberkM"
#define DRAW_DIALOGBOX_POWER06a "%d Eks"
#define PRICE_POWER06b 5000
#define DRAW_DIALOGBOX_POWER07 "PowerAresHeroLeggsW"
#define DRAW_DIALOGBOX_POWER07a "%d Eks"
#define PRICE_POWER07b 5000
#define DRAW_DIALOGBOX_POWER08 "PowerAresHeroLeggsM"
#define DRAW_DIALOGBOX_POWER08a "%d Eks"
#define PRICE_POWER08b 5000
#define DRAW_DIALOGBOX_POWER09 "PowerAresHeroRobeW"
#define DRAW_DIALOGBOX_POWER09a "%d Eks"
#define PRICE_POWER09b 5000
#define DRAW_DIALOGBOX_POWER10 "PowerAresHeroRobeM"
#define DRAW_DIALOGBOX_POWER10a "%d Eks"
#define PRICE_POWER10b 5000
#define DRAW_DIALOGBOX_POWER11 "PowerAresHeroCapW"
#define DRAW_DIALOGBOX_POWER11a "%d Eks"
#define PRICE_POWER11b 5000
#define DRAW_DIALOGBOX_POWER12 "PowerAresHeroCapM"
#define DRAW_DIALOGBOX_POWER12a "%d Eks"
#define PRICE_POWER12b 5000
#define DRAW_DIALOGBOX_POWER13 "PowerAresHeroCape"
#define DRAW_DIALOGBOX_POWER13a "%d Eks"
#define PRICE_POWER13b 5000
#define DRAW_DIALOGBOX_POWER14 "PowerAresHeroCape+1"
#define DRAW_DIALOGBOX_POWER14a "%d Eks"
#define PRICE_POWER14b 5000
//ELVINE
#define DRAW_DIALOGBOX_POWERe01 "PowerElvHeroHelmW"
#define DRAW_DIALOGBOX_POWERe01a "%d Eks"
#define PRICE_POWERe01b 5000
#define DRAW_DIALOGBOX_POWERe02 "PowerElvHeroHelmM"
#define DRAW_DIALOGBOX_POWERe02a "%d Eks"
#define PRICE_POWERe02b 5000
#define DRAW_DIALOGBOX_POWERe03 "PowerElvHeroArmorW"
#define DRAW_DIALOGBOX_POWERe03a "%d Eks"
#define PRICE_POWERe03b 5000
#define DRAW_DIALOGBOX_POWERe04 "PowerElvHeroArmorM"
#define DRAW_DIALOGBOX_POWERe04a "%d Eks"
#define PRICE_POWERe04b 5000
#define DRAW_DIALOGBOX_POWERe05 "PowerElvHeroHauberkW"
#define DRAW_DIALOGBOX_POWERe05a "%d Eks"
#define PRICE_POWERe05b 5000
#define DRAW_DIALOGBOX_POWERe06 "PowerElvHeroHauberkM"
#define DRAW_DIALOGBOX_POWERe06a "%d Eks"
#define PRICE_POWERe06b 5000
#define DRAW_DIALOGBOX_POWERe07 "PowerElvHeroLeggsW"
#define DRAW_DIALOGBOX_POWERe07a "%d Eks"
#define PRICE_POWERe07b 5000
#define DRAW_DIALOGBOX_POWERe08 "PowerElvHeroLeggsM"
#define DRAW_DIALOGBOX_POWERe08a "%d Eks"
#define PRICE_POWERe08b 5000
#define DRAW_DIALOGBOX_POWERe09 "PowerElvHeroRobeW"
#define DRAW_DIALOGBOX_POWERe09a "%d Eks"
#define PRICE_POWERe09b 5000
#define DRAW_DIALOGBOX_POWERe10 "PowerElvHeroRobeM"
#define DRAW_DIALOGBOX_POWERe10a "%d Eks"
#define PRICE_POWERe10b 5000
#define DRAW_DIALOGBOX_POWERe11 "PowerElvHeroCapW"
#define DRAW_DIALOGBOX_POWERe11a "%d Eks"
#define PRICE_POWERe11b 5000
#define DRAW_DIALOGBOX_POWERe12 "PowerElvHeroCapM"
#define DRAW_DIALOGBOX_POWERe12a "%d Eks"
#define PRICE_POWERe12b 5000
#define DRAW_DIALOGBOX_POWERe13 "PowerElvHeroCape"
#define DRAW_DIALOGBOX_POWERe13a "%d Eks"
#define PRICE_POWERe13b 5000
#define DRAW_DIALOGBOX_POWERe14 "PowerElvHeroCape+1"
#define DRAW_DIALOGBOX_POWERe14a "%d Eks"
#define PRICE_POWERe14b 5000

#define EXCHANGE_WEIGHT_LIMIT "WARNING! %s Weight Limit Reached!"
#define EXCHANGE_BAGITEM_LIMIT "WARNING! %s Bag Items Limit!"
#define EXCHANGE_HISTORY1		"%s : Add %s to Exchange"
#define EXCHANGE_HISTORY2		"%s : Remove %s to Exchange"

#define NPC_NAME_HOUNDEATH	"Hound Hell"
#define NPC_NAME_HELLICHE	"Hell Liche"
#define NPC_NAME_DEATHWYVERN	"Death Wyvern"
#define NPC_NAME_HELLBUTCHER	"Hell Butcher"
#define NPC_NAME_HELLTROLL	"Hell Troll"
#define NPC_NAME_MOUNTDEATH	"Giant Death"
#define NPC_NAME_HELLGOYLE	"Hell Gagoyle"
#define NPC_NAME_HELLDEMON	"Hell Demon"
#define NPC_NAME_HELLABBY	"Hell Abaddon"